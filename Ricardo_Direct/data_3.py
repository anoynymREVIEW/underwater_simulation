...
class depthDatasetMemory(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        complex_haze_image_name = "/home/tamondal/all_data/" + str(idx) + "complex_haze_image_name" + ".npy"
        ...
        return {'image': image_full, 'image_half': image_half_tensor, 'depth': depth_half_10_1000,
                'complex_noise_img': complex_image_tensor}
...
def getTrainingTestingData(batch_size):
    data, nyu2_train = loadZipToMem('/home/tamondal/nyu_data.zip')

    beta_mat_arr = load('/home/tamondal/CycleGAN/Beta_Mat.npy')
    a_mat_arr = load('/home/tamondal/CycleGAN/A_Mat.npy')
...
def getTestingDataOnly(batch_size):
    data, nyu2_test = loadZipToMemTest('/home/tamondal/nyu_data.zip')
