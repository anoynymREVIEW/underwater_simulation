...
parser.add_argument('--config', type=str, default='/home/tamondal/MUNIT/configs/edges2handbags_folder.yaml',
                    help='Path to the config file.')
parser.add_argument('--epoch', type=int, default=0, help='starting epoch')
parser.add_argument('--n_epochs', type=int, default=50, help='number of epochs of training')
parser.add_argument('--batchSize', type=int, default=1, help='size of the batches')
parser.add_argument('--output_path', type=str, default='/home/tamondal/MUNIT/', help="outputs path")
...
train_loader = torch.load('/home/tamondal/MUNIT/train_loader.pkl')
# torch.save(train_loader, '/home/tamondal/MUNIT/train_loader.pkl')
...
while True:
    cnt_batch = 0 # start cnt_batch with 0 and then run untill 96% of the dataset
