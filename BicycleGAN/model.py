...
class Generator(nn.Module):
    def __init__(self, z_dim=8): 
        ...
        self.conv1 = nn.Conv2d(512, 512, 1, 1, 1, bias=False)
    ...
    def forward(self, x, z):
        ...
        up_1 = nnf.interpolate(up_1, size=(3, 5), mode='bicubic', align_corners=False)

        up_2 = self.upsample_2(torch.cat([up_1, down_6], dim=1))
        up_2 = nnf.interpolate(up_2, size=(7, 10), mode='bicubic', align_corners=False)

        up_3 = self.upsample_3(torch.cat([up_2, down_5], dim=1))
        up_3 = nnf.interpolate(up_3, size=(15, 20), mode='bicubic', align_corners=False)
...
class Encoder(nn.Module):
    def __init__(self, z_dim=8):
        ...
        self.conv1 = nn.Conv2d(256, 256, (1, 2), 1, 0, bias=False)
