...
def ClacAccuracyOnly(test_loader):
    ...
    for i in range(0, N):
        ...
        saving_path_complex_imag_GT = '/sanssauvegarde/homes/t20monda/Ricardo_Direct/Resources/' + 'Batch_%d' % i + '_Complex_Imag_GT' + '.pt'
        saving_path_complex_imag_Pred = '/sanssauvegarde/homes/t20monda/Ricardo_Direct/Resources/' + 'Batch_%d' % i + '_Complex_Imag_Pred' + '.pt'
...
def LogProgress(test_loader):
    writer = SummaryWriter('/homes/t20monda/DenseDepth_3/runs/real_DenseDepth_3_Make_3D_running')
