...
from solver_water import Solver


def main(args):
    solver = Solver(result_dir=args.result_dir,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_dir', type=str, default='/home/tamondal/BicycleGAN-Simple/result',
                        help='Result images location for intermediate check')
    parser.add_argument('--weight_dir', type=str, default='/home/tamondal/BicycleGAN-Simple/weight',
