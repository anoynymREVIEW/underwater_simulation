...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--display_dir', type=str, default='/home/tamondal/DRIT/logs', help='path for saving display results')
    self.parser.add_argument('--result_dir', type=str, default='/home/tamondal/DRIT/results', help='path for saving result images and '
                                                                                  'models')
    ...
    self.parser.add_argument('--dis_norm', type=str, default='None', help='normalization layer in discriminator ['
                                                                          'None, Instance]')
    self.parser.add_argument('--dis_spectral_norm', action='store_true', help='use spectral normalization in '
                                                                              'discriminator')
    self.parser.add_argument('--lr_policy', type=str, default='lambda', help='type of learn rate decay')
    self.parser.add_argument('--n_ep', type=int, default=100, help='number of epochs') # 400 * d_iter
    self.parser.add_argument('--n_ep_decay', type=int, default=600, help='epoch start decay learning rate, set -1 if '
                                                                         'no decay') # 200 * d_iter


    self.parser.add_argument('--resume', type=str, default='/home/tamondal/DRIT/checkpoint/-0001.pth', help='specified the dir of saved models for resume '
                                                                      'the training')
    # self.parser.add_argument('--resume', type=str, default=None, help='specified the dir of saved models for resume '
    #                                                                   'the training')


    self.parser.add_argument('--d_iter', type=int, default=3, help='# of iterations for updating content discriminator')
    self.parser.add_argument('--gpu', type=int, default=2, help='gpu')
...
class TestOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--no_ms', action='store_true', help='disable mode seeking regularization')
    self.parser.add_argument('--resume', type=str, default='/sanssauvegarde/homes/t20monda/DRIT/checkpoint/-0001.pth', help='specified the dir of saved models for resume the training')
